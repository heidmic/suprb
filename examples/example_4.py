...
if __name__ == '__main__':
    ...
    model = SupRB(rule_discovery=ES1xLambda(n_iter=1000,
                                             ...
                                             init=suprb.rule.initialization.MeanInit(model=Ridge(),
                  ...
                  solution_composition=GeneticAlgorithm(n_iter=32,
                                                        ...
                                                        mutation=suprb.optimizer.solution.ga.mutation.BitFlips(
                                                            mutation_rate=0.1),
                                                        crossover=suprb.optimizer.solution.ga.crossover.NPoint(crossover_rate=0.9,
                                                                                                               n=2),
                                                        selection=suprb.optimizer.solution.ga.selection.Tournament(k=6),
                                                        init=suprb.solution.initialization.RandomInit(mixing=suprb.solution.mixing_model.ErrorExperienceHeuristic(),
