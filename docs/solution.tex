...
\draw node[right of=pool,xshift=3.5cm,yshift=-1cm,align=left] (rules) {rules are not removed from pool\\ but new rules can be added;\\ rules in pool don't change};
