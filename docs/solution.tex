...
\draw node[scale=1.5] at (0,0) (bin) {0 \blue 1 \black 0  \blue 1 \black 0 \blue 1 \black 1 1};
...
\draw node[below of=bin,xshift=2.5cm,yshift=-1.2cm,align=left] (s) {Solutions have a fitness based on error and complexity!};
