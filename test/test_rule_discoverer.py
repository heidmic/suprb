...
class TestDiscoveryRuleDiscoverer(unittest.TestCase):
    ...
    def test_split_interval_in_four(self):
        ...
        divided in 4
        """
        self.assertTrue(np.allclose(RuleDiscoverer(pool=list()).split_interval(
            [10, 30], n=4), [[10, 15], [15, 20], [20, 25], [25, 30]]))
    ...
    def test_split_interval_round_zero(self):
        ...
        """
        self.assertTrue(np.allclose(RuleDiscoverer(pool=list()).split_interval(
            [-20, 20], n=3), [[-20, -6.66666667], [-6.66666667, 6.66666667], [6.66666667, 20]]))
